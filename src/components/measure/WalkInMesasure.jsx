...
// import careacte from './../../assets/images/careacte.png'
...
//                         case 239: console.log('---mac地址'); break;
...
//                 }
//                 // console.log('结束循环蓝牙名称', bluName, bluData)
...
//                             <div className="textTitle" style={{ fontSize: px(17) }}>Head Circumference:</div>
//                             <div className="input flex" style={{ height: px(40), borderRadius: px(40) }}>
//                                 <input type="text"
...
//                         </div>
//                         <div className="item flex">
//                             <div className="textTitle" style={{ fontSize: px(17) }}>Heard to Tail Length:</div>
//                             <div className="input flex" style={{ height: px(40), borderRadius: px(40) }}>
//                                 <input type="text"
//                                     style={{ borderRadius: px(40), fontSize: px(17), paddingRight: px(20) }}
//                                     value={h2tLength}
...
//                         </div>
//                         <div className="item flex">
//                             <div className="textTitle" style={{ fontSize: px(17) }}>Neck to Tail Length:</div>
//                             <div className="input flex" style={{ height: px(40), borderRadius: px(40) }}>
//                                 <input type="text"
//                                     style={{ borderRadius: px(40), fontSize: px(17), paddingRight: px(20) }}
//                                     value={torsoLength}
...
//                         <div className="item flex">
//                             <div className="textTitle" style={{ fontSize: px(17) }}>Neck:</div>
//                             <div className="input flex" style={{ height: px(40), borderRadius: px(40) }}>
//                                 <input type="text"
//                                     style={{ borderRadius: px(40), fontSize: px(17), paddingRight: px(20) }}
...
//                         </div>
//                         <div className="item flex">
//                             <div className="textTitle" style={{ fontSize: px(17) }}>Upper Torso:</div>
//                             <div className="input flex" style={{ height: px(40), borderRadius: px(40) }}>
//                                 <input type="text"
//                                     style={{ borderRadius: px(40), fontSize: px(17), paddingRight: px(20) }}
...
//                         </div>
//                         <div className="item flex">
//                             <div className="textTitle" style={{ fontSize: px(17) }}>Lower Torso:</div>
//                             <div className="input flex" style={{ height: px(40), borderRadius: px(40) }}>
//                                 <input type="text"
//                                     style={{ borderRadius: px(40), fontSize: px(17), paddingRight: px(20) }}
