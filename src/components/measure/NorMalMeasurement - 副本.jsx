...
export default class NorMalMeasurement extends Component {
  ...
  command = (newArr) => {
    const instruction = [209, 193, 192, 129, 135, 238, 98, 97, 130, 208, 177, 194, 7, 99]
    if (newArr[2] !== 7) {
      initTime = new Date()
      num07 = 0
    } else {
    ...
    const commandArr = {
      ...
      99: () => { //广播信息
        ...
        let { isHaveBigieDate } = this.state
    ...
    return (
      <div className="l">
        <div className="petinfo">
          <div className="heard"
            style={{ height: mTop(60), marginTop: mTop(10), fontSize: px(24), paddingLeft: px(40) }}
          >
            <Tooltip placement='bottom' title='Switch Exam'>
              <MyIcon
                ...
                style={{ marginRight: px(30), fontSize: px(25) }}
                onClick={() => {
          ...
          <div className="info"
            style={{ marginTop: mTop(10), marginBottom: mTop(20), fontSize: px(16), paddingLeft: px(90) }}
          >
      ...
      <div id="clinicalMeasure">
        ...
        <div style={{ height: '55%', }}>
          ...
          <div className="close1"
            style={{ height: mTop(40) }}
          >
            {/* 菜单 */}
            <div className="menu"
              style={{ marginLeft: px(7), }}
            >
              <Menu
                style={{ height: mTop(41), }}
