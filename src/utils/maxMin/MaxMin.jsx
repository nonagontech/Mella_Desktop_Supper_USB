            ...
            <div>
                ...
                >
                    <div className="home iconfont icon-zhuye3"
                        style={{ width: px(30), height: px(30), marginLeft: px(10), lineHeight: px(0), fontSize: px(30), marginRight: px(10) }}
                        onClick={this.props.onClick}

                    />
                    <div
                        className="min iconfont icon-64"
                        style={{ width: px(30), height: px(30), marginLeft: px(10), fontSize: px(25), marginRight: px(10) }}
                        onClick={this._min}
                    ...
                    <div
                        ...
                        style={{ width: px(30), height: px(30), marginLeft: px(10), lineHeight: px(30), fontSize: px(30), marginRight: px(10) }}
                        onClick={this._close}
